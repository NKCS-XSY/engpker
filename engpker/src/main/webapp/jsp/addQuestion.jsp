			...
			<div class="container" style="min-height:500px;">
				...
				<div class="row">
                    ...
                    <div class="page-header">
                        <h2><i class="fa fa-pencil-square-o"></i> 添加试题 </h2>
                    </div>
                            ...
                            <div class="form-line form-question-opt" style="display: block;">
                                ...
                                <div class="add-opt-items">
                                    <span class="add-opt-item"><label class="que-opt-no">A</label>
											<input type="text" class="df-input-narrow form-question-opt-item GINGER_SOFTWARE_control" spellcheck="false" ginger_software_editor="true" style="position: relative; font-size: 14px; white-space: pre-wrap; line-height: 26px; background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAJkAAAAWCAYAAADTuj63AAAAeklEQVRoQ+3SQQ0AAAgDMebfNCruVwSw5NKdUyAusPi/9wocZBDkBSDLExuAjIG8AGR5YgOQMZAXgCxPbAAyBvICkOWJDUDGQF4AsjyxAcgYyAtAlic2ABkDeQHI8sQGIGMgLwBZntgAZAzkBSDLExuAjIG8AGR5YgMPkp0AF1h4ySYAAAAASUVORK5CYII=) !important; background-attachment: local !important; background-position: 0px 12px !important; background-repeat: no-repeat !important;">
											<span class="add-img add-opt-img" data-toggle="modal" data-target="#myModal" >添加图片</span>
                                    </span>
                                    ...
                                    <span class="add-opt-item"><label class="que-opt-no">C</label>
											<input type="text" class="df-input-narrow form-question-opt-item">
											<span class="add-img add-opt-img" data-toggle="modal" data-target="#myModal" >添加图片</span>  <span><i class="small-icon ques-remove-opt fa fa-minus-square" title="删除此选项"></i></span>
                                    </span>
                                    ...
                                    <div id="add-question-img-dialog" title="图片上传工具">
                                        <form>
                                            ...
                                            <div class="form-line add-update-quetstionfile">
                                                ...
                                                <div id="uploadify" class="uploadify" style="height: 26px; width: 60px;">
                                                    <object id="SWFUpload_0" type="application/x-shockwave-flash" data="http://localhost:8080/examxx/resources/js/uploadify/uploadify.swf?preventswfcaching=1433421736501" width="60" height="26" class="swfupload" style="position: absolute; z-index: 1;">
                                                        <param name="wmode" value="transparent">
                                                        <param name="movie" value="http://localhost:8080/examxx/resources/js/uploadify/uploadify.swf?preventswfcaching=1433421736501">
                                                        <param name="quality" value="high">
                                                        <param name="menu" value="false">
                                                        <param name="allowScriptAccess" value="always">
                                                        <param name="flashvars" value="movieName=SWFUpload_0&amp;uploadURL=http%3A%2F%2Flocalhost%3A8080%2Fexamxx%2Fadmin%2Fupload-uploadify-img%2F&amp;useQueryString=false&amp;requeueOnError=false&amp;httpSuccess=&amp;assumeSuccessTimeout=30&amp;params=&amp;filePostName=Filedata&amp;fileTypes=*.*&amp;fileTypesDescription=All%20Files&amp;fileSizeLimit=100&amp;fileUploadLimit=0&amp;fileQueueLimit=999&amp;debugEnabled=false&amp;buttonImageURL=%2Fexamxx%2Fadmin%2F&amp;buttonWidth=60&amp;buttonHeight=26&amp;buttonText=&amp;buttonTextTopPadding=0&amp;buttonTextLeftPadding=0&amp;buttonTextStyle=color%3A%20%23000000%3B%20font-size%3A%2016pt%3B&amp;buttonAction=-100&amp;buttonDisabled=false&amp;buttonCursor=-2">
                                                    </object>
                                                    <div id="uploadify-button" class="uploadify-button " style="height: 26px; line-height: 26px; width: 60px;"><span class="uploadify-button-text">点击上传</span>
                                                    </div>
                                                </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								南开大学 软件学院 © <a href="" target="_blank">互联网英语学习考试系统</a> - <a href="." target="_blank">主页</a> | <a href="http://www.examxx.net/" target="_blank">关于我们</a> | <a href="http://www.examxx.net/" target="_blank">FAQ</a> | <a href="http://www.examxx.net/" target="_blank">联系我们</a>
							</p>
						</div>
					</div>
				</div>
