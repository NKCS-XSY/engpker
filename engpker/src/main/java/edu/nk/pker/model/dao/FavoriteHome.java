...
import edu.nk.pker.model.po.Favorite;

/**
 * Home object for domain model class Favorite.
 * @see edu.nk.pker.model.dao.Favorite
 * @author Hibernate Tools
 */
public class FavoriteHome {

	private static final Log log = LogFactory.getLog(FavoriteHome.class);
	...
	public void persist(Favorite transientInstance) {
		log.debug("persisting Favorite instance");
		try {
	...
	public Favorite merge(Favorite detachedInstance) {
		...
		try {
			Favorite result = (Favorite) sessionFactory.getCurrentSession()
	...
	public Favorite findById(java.lang.Integer id) {
		...
		try {
			Favorite instance = (Favorite) sessionFactory.getCurrentSession()
					.get("edu.nk.pker.model.dao.Favorite", id);
			if (instance == null) {
	...
	public List findByExample(Favorite instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.nk.pker.model.dao.Favorite")
