...
import edu.nk.pker.model.po.Follow;

/**
 * Home object for domain model class Follow.
 * @see edu.nk.pker.model.dao.Follow
...
public class FollowHome {
	...
	public Follow merge(Follow detachedInstance) {
		...
		try {
			Follow result = (Follow) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Follow findById(java.lang.Integer id) {
		...
		try {
			Follow instance = (Follow) sessionFactory.getCurrentSession().get(
					"edu.nk.pker.model.dao.Follow", id);
			if (instance == null) {
	...
	public List findByExample(Follow instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("edu.nk.pker.model.dao.Follow")
